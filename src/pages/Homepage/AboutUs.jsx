...
const Aboutus = () => {
  return (
    ...
    >
      <h1 className="text-primary font-black text-4xl text-center">About us</h1>
      <div className="grid grid-cols-2 py-14">
        {/* col-1 */}
        <div className="space-y-5 w-9/12">
          <p className="text-primary font-black ms-24 md:text-3xl flex-1 ">
            Together, We Create Brighter Futures
          </p>
          <p className=" ms-24 md:text-sm ">
            ...
            physically challenged individuals who learn, grow, and live together
          ...
          <p className=" ms-24 md:text-sm">
            ...
            donors, we continue to create a nurturing community where every life
            shines with hope and possibility.
          </p>
        </div>
        {/* col-2 */}
