  ...
  return (
    <section className=" md:container">
      <div className="md:shadow-2xl py-16 grid grid-cols-1 lg:grid-cols-2 gap-y-16 rounded-md">
        ...
        <div className="bg-primary w-5/6 xl:w-4/6 mx-auto px-4 md:px-8 py-10 flex flex-col gap-3 rounded">
          ...
          <div className="py-8 space-y-5">
            {Data.map((item) => (
              <div
                key={item.id}
                className="bg-white text-black rounded-md p-2 md:p-4  flex gap-4 items-center"
              >
                <div className="text-white bg-primary text-2xl md:text-4xl p-1.5 flex justify-center items-center rounded-sm">
                  {item.icon}
                </div>
                <div className="">
        ...
        {/* Get a Quote div */}
        <div className=" mx-auto lg:mx-0 w-5/6 space-y-5">
